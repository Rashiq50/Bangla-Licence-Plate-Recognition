  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "AnonymousIterator", name,
        tld.op_callbacks, "output_types", output_types, "output_shapes",
        output_shapes)
      return _result
...
def anonymous_iterator_v2(output_types, output_shapes, name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "AnonymousIteratorV2", name,
        tld.op_callbacks, "output_types", output_types, "output_shapes",
        output_shapes)
...
def anonymous_memory_cache(name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "AnonymousMemoryCache", name,
        tld.op_callbacks)
...
def anonymous_multi_device_iterator(devices, output_types, output_shapes, name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "AnonymousMultiDeviceIterator",
        name, tld.op_callbacks, "devices", devices, "output_types",
...
def anonymous_random_seed_generator(seed, seed2, name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "AnonymousRandomSeedGenerator",
        name, tld.op_callbacks, seed, seed2)
...
def batch_dataset(input_dataset, batch_size, output_types, output_shapes, name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "BatchDataset", name,
        tld.op_callbacks, input_dataset, batch_size, "output_types",
        output_types, "output_shapes", output_shapes)
      return _result
    except _core._FallbackException:
      try:
...
def batch_dataset_v2(input_dataset, batch_size, drop_remainder, output_types, output_shapes, parallel_copy=False, name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "BatchDatasetV2", name,
        tld.op_callbacks, input_dataset, batch_size, drop_remainder,
...
def cache_dataset(input_dataset, filename, output_types, output_shapes, name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "CacheDataset", name,
        tld.op_callbacks, input_dataset, filename, "output_types",
        output_types, "output_shapes", output_shapes)
      return _result
    except _core._FallbackException:
      try:
...
def cache_dataset_v2(input_dataset, filename, cache, output_types, output_shapes, name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "CacheDatasetV2", name,
        tld.op_callbacks, input_dataset, filename, cache, "output_types",
        output_types, "output_shapes", output_shapes)
      return _result
    except _core._FallbackException:
      try:
...
def concatenate_dataset(input_dataset, another_dataset, output_types, output_shapes, name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "ConcatenateDataset", name,
        tld.op_callbacks, input_dataset, another_dataset, "output_types",
        output_types, "output_shapes", output_shapes)
      return _result
    except _core._FallbackException:
      try:
...
def dataset_to_graph(input_dataset, stateful_whitelist=[], allow_stateful=False, strip_device_assignment=False, name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "DatasetToGraph", name,
        tld.op_callbacks, input_dataset, "stateful_whitelist",
...
def dataset_to_graph_v2(input_dataset, external_state_policy=0, strip_device_assignment=False, name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "DatasetToGraphV2", name,
        tld.op_callbacks, input_dataset, "external_state_policy",
        external_state_policy, "strip_device_assignment",
        strip_device_assignment)
      return _result
    except _core._FallbackException:
      try:
...
def dataset_to_single_element(dataset, output_types, output_shapes, name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "DatasetToSingleElement", name,
        tld.op_callbacks, dataset, "output_types", output_types,
        "output_shapes", output_shapes)
      return _result
    except _core._FallbackException:
      try:
...
def delete_iterator(handle, deleter, name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "DeleteIterator", name,
...
def delete_memory_cache(handle, deleter, name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "DeleteMemoryCache", name,
        tld.op_callbacks, handle, deleter)
      return _result
    except _core._FallbackException:
      try:
...
def delete_multi_device_iterator(multi_device_iterator, iterators, deleter, name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "DeleteMultiDeviceIterator",
        name, tld.op_callbacks, multi_device_iterator, iterators, deleter)
      return _result
    except _core._FallbackException:
      try:
...
def delete_random_seed_generator(handle, deleter, name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "DeleteRandomSeedGenerator",
        name, tld.op_callbacks, handle, deleter)
      return _result
    except _core._FallbackException:
      try:
...
def deserialize_iterator(resource_handle, serialized, name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "DeserializeIterator", name,
        tld.op_callbacks, resource_handle, serialized)
      return _result
    except _core._FallbackException:
      try:
...
def filter_by_last_component_dataset(input_dataset, output_types, output_shapes, name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "FilterByLastComponentDataset",
...
def filter_dataset(input_dataset, other_arguments, predicate, output_types, output_shapes, name=None):
  ...
  * One tensor for each value in `other_arguments`.
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "FilterDataset", name,
...
def fixed_length_record_dataset(filenames, header_bytes, record_bytes, footer_bytes, buffer_size, name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "FixedLengthRecordDataset",
        name, tld.op_callbacks, filenames, header_bytes, record_bytes,
...
def fixed_length_record_dataset_v2(filenames, header_bytes, record_bytes, footer_bytes, buffer_size, compression_type, name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "FixedLengthRecordDatasetV2",
        name, tld.op_callbacks, filenames, header_bytes, record_bytes,
...
def flat_map_dataset(input_dataset, other_arguments, f, output_types, output_shapes, name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "FlatMapDataset", name,
...
def generator_dataset(init_func_other_args, next_func_other_args, finalize_func_other_args, init_func, next_func, finalize_func, output_types, output_shapes, name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "GeneratorDataset", name,
        tld.op_callbacks, init_func_other_args, next_func_other_args,
        finalize_func_other_args, "init_func", init_func, "next_func",
        next_func, "finalize_func", finalize_func, "output_types",
        output_types, "output_shapes", output_shapes)
      return _result
    except _core._FallbackException:
      try:
...
def interleave_dataset(input_dataset, other_arguments, cycle_length, block_length, f, output_types, output_shapes, name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "InterleaveDataset", name,
        tld.op_callbacks, input_dataset, other_arguments, cycle_length,
        block_length, "f", f, "output_types", output_types, "output_shapes",
        output_shapes)
      return _result
    except _core._FallbackException:
      try:
...
def iterator(shared_name, container, output_types, output_shapes, name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "Iterator", name,
...
def iterator_from_string_handle(string_handle, output_types=[], output_shapes=[], name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "IteratorFromStringHandle",
        name, tld.op_callbacks, string_handle, "output_types", output_types,
        "output_shapes", output_shapes)
      return _result
    except _core._FallbackException:
      try:
...
def iterator_from_string_handle_v2(string_handle, output_types=[], output_shapes=[], name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "IteratorFromStringHandleV2",
        name, tld.op_callbacks, string_handle, "output_types", output_types,
        "output_shapes", output_shapes)
      return _result
    except _core._FallbackException:
...
def iterator_get_next(iterator, output_types, output_shapes, name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "IteratorGetNext", name,
        tld.op_callbacks, iterator, "output_types", output_types,
        "output_shapes", output_shapes)
      return _result
    except _core._FallbackException:
      try:
...
def iterator_get_next_as_optional(iterator, output_types, output_shapes, name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "IteratorGetNextAsOptional",
        name, tld.op_callbacks, iterator, "output_types", output_types,
        "output_shapes", output_shapes)
      return _result
    except _core._FallbackException:
      try:
...
def iterator_get_next_sync(iterator, output_types, output_shapes, name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "IteratorGetNextSync", name,
        tld.op_callbacks, iterator, "output_types", output_types,
        "output_shapes", output_shapes)
      return _result
    except _core._FallbackException:
...
def iterator_to_string_handle(resource_handle, name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "IteratorToStringHandle", name,
        tld.op_callbacks, resource_handle)
      return _result
    except _core._FallbackException:
      try:
...
def iterator_v2(shared_name, container, output_types, output_shapes, name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "IteratorV2", name,
        tld.op_callbacks, "shared_name", shared_name, "container", container,
        "output_types", output_types, "output_shapes", output_shapes)
      return _result
    except _core._FallbackException:
...
def make_iterator(dataset, iterator, name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "MakeIterator", name,
...
def map_dataset(input_dataset, other_arguments, f, output_types, output_shapes, use_inter_op_parallelism=True, preserve_cardinality=False, name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "MapDataset", name,
        tld.op_callbacks, input_dataset, other_arguments, "f", f,
        "output_types", output_types, "output_shapes", output_shapes,
...
def map_defun(arguments, captured_inputs, output_types, output_shapes, f, max_intra_op_parallelism=1, name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "MapDefun", name,
        tld.op_callbacks, arguments, captured_inputs, "output_types",
...
def model_dataset(input_dataset, output_types, output_shapes, algorithm=0, cpu_budget=0, name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "ModelDataset", name,
        tld.op_callbacks, input_dataset, "algorithm", algorithm, "cpu_budget",
        cpu_budget, "output_types", output_types, "output_shapes",
        output_shapes)
      return _result
    except _core._FallbackException:
      try:
  ...
  if _execute.must_record_gradient():
    _attrs = ("algorithm", _op._get_attr_int("algorithm"), "cpu_budget",
              _op._get_attr_int("cpu_budget"), "output_types",
              _op.get_attr("output_types"), "output_shapes",
              _op.get_attr("output_shapes"))
    _inputs_flat = _op.inputs
    _execute.record_gradient(
...
def model_dataset_eager_fallback(input_dataset, output_types, output_shapes, algorithm, cpu_budget, name, ctx):
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'model_dataset' Op, not %r." % output_types)
...
def multi_device_iterator(devices, shared_name, container, output_types, output_shapes, name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "MultiDeviceIterator", name,
        tld.op_callbacks, "devices", devices, "shared_name", shared_name,
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        ...
        "MultiDeviceIteratorFromStringHandle", name, tld.op_callbacks,
...
def multi_device_iterator_get_next_from_shard(multi_device_iterator, shard_num, incarnation_id, output_types, output_shapes, name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name,
        "MultiDeviceIteratorGetNextFromShard", name, tld.op_callbacks,
...
def multi_device_iterator_init(dataset, multi_device_iterator, max_buffer_size, name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "MultiDeviceIteratorInit",
        name, tld.op_callbacks, dataset, multi_device_iterator,
        max_buffer_size)
      return _result
    except _core._FallbackException:
      try:
...
def multi_device_iterator_to_string_handle(multi_device_iterator, name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name,
        "MultiDeviceIteratorToStringHandle", name, tld.op_callbacks,
...
def one_shot_iterator(dataset_factory, output_types, output_shapes, container="", shared_name="", name=None):
  ...
  * They are not resettable. Once a one-shot iterator reaches the end of its
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "OneShotIterator", name,
        tld.op_callbacks, "dataset_factory", dataset_factory, "output_types",
        output_types, "output_shapes", output_shapes, "container", container,
...
def optimize_dataset(input_dataset, optimizations, output_types, output_shapes, optimization_configs=[], name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "OptimizeDataset", name,
        tld.op_callbacks, input_dataset, optimizations, "output_types",
...
def optional_from_value(components, name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "OptionalFromValue", name,
...
def optional_get_value(optional, output_types, output_shapes, name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "OptionalGetValue", name,
        tld.op_callbacks, optional, "output_types", output_types,
        "output_shapes", output_shapes)
      return _result
    except _core._FallbackException:
      try:
...
def optional_has_value(optional, name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "OptionalHasValue", name,
        tld.op_callbacks, optional)
      return _result
    except _core._FallbackException:
      try:
...
def optional_none(name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "OptionalNone", name,
        tld.op_callbacks)
      return _result
    except _core._FallbackException:
      try:
...
def padded_batch_dataset(input_dataset, batch_size, padded_shapes, padding_values, output_shapes, name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "PaddedBatchDataset", name,
        tld.op_callbacks, input_dataset, batch_size, padded_shapes,
        padding_values, "output_shapes", output_shapes)
      return _result
    except _core._FallbackException:
      try:
...
def padded_batch_dataset_v2(input_dataset, batch_size, padded_shapes, padding_values, drop_remainder, output_shapes, parallel_copy=False, name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "PaddedBatchDatasetV2", name,
        tld.op_callbacks, input_dataset, batch_size, padded_shapes,
        padding_values, drop_remainder, "parallel_copy", parallel_copy,
        "output_shapes", output_shapes)
      return _result
    except _core._FallbackException:
      try:
...
def parallel_interleave_dataset_v2(input_dataset, other_arguments, cycle_length, block_length, num_parallel_calls, f, output_types, output_shapes, sloppy=False, name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "ParallelInterleaveDatasetV2",
        name, tld.op_callbacks, input_dataset, other_arguments, cycle_length,
        block_length, num_parallel_calls, "f", f, "output_types",
...
def parallel_interleave_dataset_v3(input_dataset, other_arguments, cycle_length, block_length, num_parallel_calls, f, output_types, output_shapes, deterministic="default", name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "ParallelInterleaveDatasetV3",
        name, tld.op_callbacks, input_dataset, other_arguments, cycle_length,
        block_length, num_parallel_calls, "f", f, "deterministic",
...
def parallel_interleave_dataset_v4(input_dataset, other_arguments, cycle_length, block_length, buffer_output_elements, prefetch_input_elements, num_parallel_calls, f, output_types, output_shapes, deterministic="default", name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "ParallelInterleaveDatasetV4",
        name, tld.op_callbacks, input_dataset, other_arguments, cycle_length,
        block_length, buffer_output_elements, prefetch_input_elements,
        num_parallel_calls, "f", f, "deterministic", deterministic,
        "output_types", output_types, "output_shapes", output_shapes)
      return _result
    except _core._FallbackException:
...
def parallel_map_dataset(input_dataset, other_arguments, num_parallel_calls, f, output_types, output_shapes, use_inter_op_parallelism=True, sloppy=False, preserve_cardinality=False, name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "ParallelMapDataset", name,
        tld.op_callbacks, input_dataset, other_arguments, num_parallel_calls,
...
def parallel_map_dataset_v2(input_dataset, other_arguments, num_parallel_calls, f, output_types, output_shapes, use_inter_op_parallelism=True, deterministic="default", preserve_cardinality=False, name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "ParallelMapDatasetV2", name,
        tld.op_callbacks, input_dataset, other_arguments, num_parallel_calls,
        "f", f, "output_types", output_types, "output_shapes", output_shapes,
        "use_inter_op_parallelism", use_inter_op_parallelism, "deterministic",
        deterministic, "preserve_cardinality", preserve_cardinality)
      return _result
    except _core._FallbackException:
      try:
...
def prefetch_dataset(input_dataset, buffer_size, output_types, output_shapes, slack_period=0, legacy_autotune=True, name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "PrefetchDataset", name,
        tld.op_callbacks, input_dataset, buffer_size, "output_types",
        output_types, "output_shapes", output_shapes, "slack_period",
        slack_period, "legacy_autotune", legacy_autotune)
      return _result
    except _core._FallbackException:
      try:
  ...
  if _execute.must_record_gradient():
    _attrs = ("output_types", _op.get_attr("output_types"), "output_shapes",
              ...
              _op._get_attr_bool("legacy_autotune"))
    _inputs_flat = _op.inputs
    _execute.record_gradient(
...
def prefetch_dataset_eager_fallback(input_dataset, buffer_size, output_types, output_shapes, slack_period, legacy_autotune, name, ctx):
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'prefetch_dataset' Op, not %r." % output_types)
...
def range_dataset(start, stop, step, output_types, output_shapes, name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "RangeDataset", name,
        tld.op_callbacks, start, stop, step, "output_types", output_types,
        "output_shapes", output_shapes)
      return _result
    except _core._FallbackException:
      try:
...
def reduce_dataset(input_dataset, initial_state, other_arguments, f, output_types, output_shapes, use_inter_op_parallelism=True, name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "ReduceDataset", name,
...
def repeat_dataset(input_dataset, count, output_types, output_shapes, name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "RepeatDataset", name,
        tld.op_callbacks, input_dataset, count, "output_types", output_types,
        "output_shapes", output_shapes)
      return _result
    except _core._FallbackException:
      try:
...
def serialize_iterator(resource_handle, external_state_policy=0, name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "SerializeIterator", name,
        tld.op_callbacks, resource_handle, "external_state_policy",
...
def shard_dataset(input_dataset, num_shards, index, output_types, output_shapes, require_non_empty=False, name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "ShardDataset", name,
        tld.op_callbacks, input_dataset, num_shards, index,
...
def shuffle_and_repeat_dataset(input_dataset, buffer_size, seed, seed2, count, output_types, output_shapes, name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "ShuffleAndRepeatDataset",
        name, tld.op_callbacks, input_dataset, buffer_size, seed, seed2,
...
def shuffle_and_repeat_dataset_eager_fallback(input_dataset, buffer_size, seed, seed2, count, output_types, output_shapes, name, ctx):
  if not isinstance(output_types, (list, tuple)):
    raise TypeError(
        "Expected list for 'output_types' argument to "
        "'shuffle_and_repeat_dataset' Op, not %r." % output_types)
...
def shuffle_dataset(input_dataset, buffer_size, seed, seed2, output_types, output_shapes, reshuffle_each_iteration=True, name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "ShuffleDataset", name,
        tld.op_callbacks, input_dataset, buffer_size, seed, seed2,
...
def shuffle_dataset_v2(input_dataset, buffer_size, seed_generator, output_types, output_shapes, name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "ShuffleDatasetV2", name,
        tld.op_callbacks, input_dataset, buffer_size, seed_generator,
        "output_types", output_types, "output_shapes", output_shapes)
      return _result
    except _core._FallbackException:
      try:
...
def skip_dataset(input_dataset, count, output_types, output_shapes, name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "SkipDataset", name,
        tld.op_callbacks, input_dataset, count, "output_types", output_types,
        "output_shapes", output_shapes)
      return _result
    except _core._FallbackException:
...
def sparse_tensor_slice_dataset(indices, values, dense_shape, name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "SparseTensorSliceDataset",
        name, tld.op_callbacks, indices, values, dense_shape)
      return _result
    except _core._FallbackException:
      try:
...
def tf_record_dataset(filenames, compression_type, buffer_size, name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "TFRecordDataset", name,
        tld.op_callbacks, filenames, compression_type, buffer_size)
      return _result
    except _core._FallbackException:
      try:
...
def take_dataset(input_dataset, count, output_types, output_shapes, name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "TakeDataset", name,
        tld.op_callbacks, input_dataset, count, "output_types", output_types,
        "output_shapes", output_shapes)
      return _result
    except _core._FallbackException:
...
def tensor_dataset(components, output_shapes, name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "TensorDataset", name,
        tld.op_callbacks, components, "output_shapes", output_shapes)
      return _result
    except _core._FallbackException:
      try:
...
def tensor_slice_dataset(components, output_shapes, name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "TensorSliceDataset", name,
        tld.op_callbacks, components, "output_shapes", output_shapes)
      return _result
    except _core._FallbackException:
      try:
...
def text_line_dataset(filenames, compression_type, buffer_size, name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "TextLineDataset", name,
        tld.op_callbacks, filenames, compression_type, buffer_size)
      return _result
    except _core._FallbackException:
      try:
...
def unwrap_dataset_variant(input_handle, name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "UnwrapDatasetVariant", name,
        tld.op_callbacks, input_handle)
      return _result
    except _core._FallbackException:
      try:
...
def window_dataset(input_dataset, size, shift, stride, drop_remainder, output_types, output_shapes, name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "WindowDataset", name,
        tld.op_callbacks, input_dataset, size, shift, stride, drop_remainder,
        "output_types", output_types, "output_shapes", output_shapes)
      return _result
    except _core._FallbackException:
      try:
...
def wrap_dataset_variant(input_handle, name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "WrapDatasetVariant", name,
        tld.op_callbacks, input_handle)
      return _result
    except _core._FallbackException:
      try:
...
def zip_dataset(input_datasets, output_types, output_shapes, name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "ZipDataset", name,
        tld.op_callbacks, input_datasets, "output_types", output_types,
        "output_shapes", output_shapes)
      return _result
    except _core._FallbackException:
      try:
